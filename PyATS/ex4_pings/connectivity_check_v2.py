...
# CommonSetup-SubSec
    ...
    @aetest.subsection
    def establish_connections(self, steps, HQ_C1, HQ_C2, HQ_C3, HQ_C4):
    ...
    @aetest.subsection
    def setup_ip_addresses(self, steps, HQ_C1, HQ_C2, HQ_C3, HQ_C4):
...
class TESTCASE_1_PING_FROM_HQ_CLIENTS_TO_ISP(aetest.Testcase):
    ...
    def T1_PING_FROM_HQ_C1_TO_ISP(self, HQ_C1):
        try:
            ...
            match = re.search('timeout', result) or re.search('not reachable|host unreachable', result)
            print('################')
...
class CommonCleanup(aetest.CommonCleanup):
    ...
    @aetest.subsection
    def disconnect(self, steps, HQ_C1, HQ_C2, HQ_C3, HQ_C4):
